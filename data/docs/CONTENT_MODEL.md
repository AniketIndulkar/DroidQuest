...
The current graph publishes complete Levels 1–5. Lessons and weekly checkpoints form an acyclic prerequisite chain through each level boss. Level 5 starts only after the Level 4 boss, and the planned Level 6 preview depends on the completed Level 5 boss. Later level previews remain chained in curriculum order.
